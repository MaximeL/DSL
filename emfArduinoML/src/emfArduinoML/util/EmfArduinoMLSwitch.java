 ...
 * @generated
 */
public class EmfArduinoMLSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static EmfArduinoMLPackage modelPackage;
	 ...
	 * @generated
	 */
	public EmfArduinoMLSwitch() {
		if (modelPackage == null) {
			modelPackage = EmfArduinoMLPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EmfArduinoMLPackage.BRICK: {
				Brick brick = (Brick)theEObject;
				T result = caseBrick(brick);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case EmfArduinoMLPackage.SENSOR: {
			...
			case EmfArduinoMLPackage.ACTUATOR: {
