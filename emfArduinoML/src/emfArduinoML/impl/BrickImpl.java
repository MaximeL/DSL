 ...
 * </p>
 * <ul>
 *   <li>{@link emfArduinoML.impl.BrickImpl#getName <em>Name</em>}</li>
 *   <li>{@link emfArduinoML.impl.BrickImpl#getPin <em>Pin</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class BrickImpl extends MinimalEObjectImpl.Container implements Brick {
	...
	protected EClass eStaticClass() {
		return EmfArduinoMLPackage.Literals.BRICK;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfArduinoMLPackage.BRICK__NAME, oldName, name));
	}
	...
	public void setPin(int newPin) {
		...
		pin = newPin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EmfArduinoMLPackage.BRICK__PIN, oldPin, pin));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EmfArduinoMLPackage.BRICK__NAME:
				return getName();
			case EmfArduinoMLPackage.BRICK__PIN:
				return getPin();
		}
